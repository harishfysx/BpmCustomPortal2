...
//get Nurse Tasks
router.post('/labTechTasks',function(req, res, next) {
	...
	xhr.put({
        ...
        params: {
            condition: ['taskActivityName|Equals|Perform Lab Tests', 'taskStatus|Equals|Received'],
...
router.get('/labTechTask/:id',function(req, res, next) {
	console.log(res.locals.userName)
